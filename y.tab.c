...
const int YY_parse_CLASS::TK_MAIN=260;
const int YY_parse_CLASS::TK_ID=261;
const int YY_parse_CLASS::TK_TIPO_INT=262;
const int YY_parse_CLASS::TK_TIPO_FLOAT=263;
